...
const submit = () => {
    form.transform(data => ({
        ...
        onFinish: () => {
            form.reset('password');
            // Jeśli jest parametr redirect, przekieruj użytkownika po zalogowaniu
            if (props.redirect) {
    ...
    <AuthenticationCard>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="flex items-center justify-between mt-4">
                ...
                <div>
                    <Link v-if="canResetPassword" :href="route('password.request')" class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800 mr-4">
                        Zapomniałeś hasła?
                    </Link>
