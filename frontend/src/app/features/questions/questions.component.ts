...
export class QuestionsComponent {
  faqItems: FaqItem[] = [
    ...
    },
    {
      ...
      answer: 'Tak, jeśli wyrazisz zgodę na udostępnienie swojej lokalizacji, aplikacja może rekomendować restauracje znajdujące się w Twojej okolicy. Możesz również ręcznie wprowadzić preferowaną lokalizację lub dzielnicę miasta.',
      category: 'Funkcje'
    },
    {
